...
class S3Operation:
    ...
    def read_object(
        ...
        """Read object This method reads the object_name with kwargs
        ...
        Returns:
            Union[StringIO, str]: The column name is renamed
        """
        logging.info("Enterd the read_object method of S3Operation class")
        try:
            func = (
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        ...
        logging.info("Enterd the get_bucket method of S3Operations class")
        try:
